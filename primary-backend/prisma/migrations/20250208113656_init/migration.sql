...
-- CreateTable
CREATE TABLE "AvailbleAction" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "image" TEXT NOT NULL,

    CONSTRAINT "AvailbleAction_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Action" ADD CONSTRAINT "Action_actionId_fkey" FOREIGN KEY ("actionId") REFERENCES "AvailbleAction"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
